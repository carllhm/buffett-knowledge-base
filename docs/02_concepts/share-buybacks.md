...
| 年份 | 重点内容 |
|:---|:---|
| **[核心总结](/01_letters/1984年/核心总结)** | 早期对回购的谨慎态度 |
| **[核心总结](/01_letters/1999年/核心总结)** | 明确回购的前提条件 |
| **[核心总结](/01_letters/2000年/核心总结)** | 回购与留存收益的税收对比 |
| **[核心总结](/01_letters/2011年/核心总结)** | 伯克希尔首次大规模回购 |
| **[核心总结](/01_letters/2012年/核心总结)** | 明确回购的三个条件 |
| **[核心总结](/01_letters/2019年/核心总结)** | 苹果回购与股东利益 |
...
2016年巴菲特正式宣布伯克希尔的回购政策：

> "当股价显著低于内在价值时，我们将回购股票。但我们只会以账面价值的120%或以下的价格回购。"

这一上限看似宽松，实则体现了极高的标准：**只有在股价低于账面价值20%以上时才考虑回购。** 当时许多伯克希尔的控股子公司价值远超账面价值，这意味着回购条件极为苛刻。

他还系统阐述了回购的复杂性：

> "对于退出的股东，回购总是好事——多了一个买家。但对于继续持股的股东，取决于购买价格。低于内在价值回购，立即增加每股价值；高于内在价值回购，则损害继续持股股东。"

这段话将回购的利弊分析得极为清晰，是理解回购的最简框架。
...
2022年，面对市场波动，伯克希尔继续执行回购：

> "2022年，我们回购了约1.2%的流通股。这是在股价显著低于内在价值时进行的，对留下的股东有利。"
...
> "伯克希尔不支付股息。股票回购完全由管理层自由裁量——我们只在认为股票价值显著低于内在价值时才回购。"

这句话将回购与股息的本质区别推向了最高点：**股息是强制的——无论管理层怎么想，政府都会来征税；回购是自由的——只有当管理层认为股价便宜时才进行。** 这也是巴菲特一生不派股息的根本原因：留钱在他手中，可以在最有利的时候、最有利的价格进行配置，而不是被动的分发。
...
- [[核心总结|1984年：核心总结]] → [[1984年：完整翻译|/01_letters/1984年/翻译]]
